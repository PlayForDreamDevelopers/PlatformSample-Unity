...
- 添加对OptimizeBufferDiscard的支持

### Changed

- 将systemSplashScreen和6Dof重命名
...
- 添加到org.khronos.openxr.intent.category.IMMERSIVE_HMD的category到AndroidManifest.xml

## [1.10.2] - 2023-09-12

### Add

- 添加Project Setup Tool的Status Icon提示
- 添加3Dof/6Dof uses-feature到AndroidManifest.xml
...
- 添加OS Splash Screen功能

## [1.9.4] - 2023-08-25

### Fixed

- 修复resume后ProjectionLayer卡的问题
