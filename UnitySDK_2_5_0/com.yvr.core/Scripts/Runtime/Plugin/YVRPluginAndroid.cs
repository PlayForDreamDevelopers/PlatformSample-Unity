...
namespace YVR.Core
{
    ...
    public class YVRPluginAndroid : YVRPlugin
    {
        ...
        private static extern void YVRGetHandHandJointLocations(HandType handType,
                                                                ref HandData handData, IntPtr handJointLocationsPtr, IntPtr jointVelocitiesHandle);
        ...
        public override void SetBoundrayDetectionEnable(bool enable) { YVRSetBoundaryDetectionEnable(enable); }
        ...
        public override void GetHandJointLocations(HandType handType, ref HandJointLocations jointLocations)
        {
            ...
            YVRGetHandHandJointLocations(handType, ref handData,
                (handType == HandType.HandLeft ? m_LJointLocationsHandle : m_RJointLocationsHandle)
                .AddrOfPinnedObject(),
                (handType == HandType.HandLeft ? m_LJointVelocitiesHandle : m_RJointVelocitiesHandle)
                .AddrOfPinnedObject());
        ...
        public override void SetAppSpaceRotation(float x, float y, float z, float w) { YVRSetAppSpaceRotation(x, y, z, w); }
