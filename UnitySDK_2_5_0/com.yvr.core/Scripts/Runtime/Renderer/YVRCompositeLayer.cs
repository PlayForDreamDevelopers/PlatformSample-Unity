...
namespace YVR.Core
{
    ...
    public class YVRCompositeLayer : MonoBehaviour
    {
        ...
        public void InitCompositeLayer(int depth = int.MinValue)
        {
            ...
            var layerCreateInfo = new YVRLayerCreateInfo(compositionDepth, width, height, swapChainBufferCount, m_Shape, isActiveAndEnabled);
        ...
        protected void CopyTextureToColorHandle()
        {
